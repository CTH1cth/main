...
EXP_NAME = "dinov1_s8_dabepu_v11_dagp_uncgate_ndr_v2a_rast_v12_esa_asym_long45_lceg_v1_cc_lrfloor_2e5"
...
USE_RAST = True
RAST_VERSION = "v1.2_esa_asym_ndr_v2a"
RAST_START_EPOCH = 7
...
USE_LCEG = True
LCEG_VERSION = "v1_late_core_extent_guard_cc45_ndr_v2a"
LCEG_START_EPOCH = 26
...
# NDR-v2a: shape-aware gate plus reliable-background positive residual lock.
USE_NDR_BRANCH = True
USE_NDR_V2 = True
NDR_VERSION = "v2a_shape_gate_bg_lock"
...
NDR_V2_BG_LOCK_WEIGHT = 0.005
NDR_V2_BG_CORE_THRESH = 0.5
NDR_V2_BG_LOCK_USE_LOW_TARGET = True
NDR_V2_BG_LOCK_TARGET_THRESH = 0.15
NDR_V2_BG_LOCK_WEIGHT_THRESH = 0.50
NDR_V2_BG_LOCK_DETACH_MASK = True
NDR_V2_BG_LOCK_EPS = 1e-6

NDR_V2_USE_SHAPE_LOWER_BOUND = False
