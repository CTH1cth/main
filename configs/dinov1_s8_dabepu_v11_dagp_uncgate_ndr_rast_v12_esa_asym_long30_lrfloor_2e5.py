from configs.dinov1_s8_dabepu_v11_dagp_uncgate_ndr_rast_v12_esa_asym_lrfloor_2e5 import *  # noqa: F401,F403


EXP_NAME = "dinov1_s8_dabepu_v11_dagp_uncgate_ndr_rast_v12_esa_asym_long30_lrfloor_2e5"

MAX_EPOCH = 30
max_epoch = 30

# Keep optimizer/LR policy identical to the 25e ESA-Asym baseline.
DINO = dict(DINO)
DINO["lr"] = 0.0006
LR = 0.0006
...
# Keep the DESPL-style reset exactly aligned with the 25e ESA-Asym baseline.
...
# Save every epoch for this small ablation so epoch_020.pth through epoch_030.pth exist.
SAVE_INTERVAL = 1
