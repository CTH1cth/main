from configs.dinov1_s8_dabepu_v11_dagp_uncgate_ndr_rast_v12_esa_asym_long40_lceg_v1_cc_lrfloor_2e5 import *  # noqa: F401,F403


EXP_NAME = "dinov1_s8_dabepu_v11_dagp_uncgate_ndr_rast_v12_esa_asym_long45_lceg_v1_cc_lrfloor_2e5"
...
# Lock Long40-CC protocol. Epoch36-45 remain clean teacher-only.
DINO = dict(DINO)
DINO["lr"] = 0.0006
LR = 0.0006
lr = 0.0006
...
USE_LCEG = True
LCEG_VERSION = "v1_late_core_extent_guard_cc45"
LCEG_START_EPOCH = 26
