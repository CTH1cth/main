...
EXP_NAME = "dinov1_s8_despl_only_sap_rcim_adapt"

HEAD_TYPE = "sap_rcim"

USE_MULTI_LEVEL_FEATURE = True
MULTI_LEVEL_FEATURE_ROOT = "../datasets/cache/features_cache_sap_rcim_fp16"
MULTI_LEVEL_LAYERS = [10, 11, 12]
