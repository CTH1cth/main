from configs.dinov1_s8_dabepu_v11_apstcr_v2_conflictpass_dagp_uncgate_ndr_long45_lrfloor_2e5 import *  # noqa: F401,F403


EXP_NAME = (
    "dinov1_s8_dabepu_v11_apstcr_v3_softdev_"
...
AP_STCR = {
    ...
    "temporal_window": 3,
    "tau_temporal": 0.20,
    # This value is only a shared temporal-interface sentinel. When history is
    # invalid, v3 selects semantic support directly instead of averaging it.
