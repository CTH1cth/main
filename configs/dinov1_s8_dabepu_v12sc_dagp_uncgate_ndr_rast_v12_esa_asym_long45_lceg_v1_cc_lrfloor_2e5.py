...
EXP_NAME = "dinov1_s8_dabepu_v12sc_dagp_uncgate_ndr_rast_v12_esa_asym_long45_lceg_v1_cc_lrfloor_2e5"
...
USE_LCEG = True
LCEG_VERSION = "v1_late_core_extent_guard_dabepu_v12sc"
LCEG_COVER_CACHE_ROOT = "../datasets/cache/lceg_cover_cache/dinov1-s8/dabepu_v12sc_precover25_epoch025"
...
# Keep the base model as DAGP-Safe + NDR-v1; no NDR-v2 patch branch in this source-pseudo experiment.
USE_NDR_BRANCH = True
USE_NDR_V2 = False
