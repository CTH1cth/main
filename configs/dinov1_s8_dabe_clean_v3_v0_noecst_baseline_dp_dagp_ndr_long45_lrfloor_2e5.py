"""V0: exact A1 Clean-DP target on the pure-offline v3 data path."""
...
EXP_NAME = "dinov1_s8_dabe_clean_v3_v0_noecst_baseline_dp_dagp_ndr_long45_lrfloor_2e5"
DABE_CLEAN_VERSION = "v3_offline_consolidation"
DABE_CLEAN_EXPECTED_PAYLOAD_VERSION = "dabe_clean_v3_offline_consolidation"
DABE_CLEAN_OFFLINE_MODE = "baseline_dp"
DABE_CLEAN_ROOT = (
    "../datasets/cache/dabe_clean_v3_v0_baseline_dp_pseudo_cache/dinov1-s8"
)

# These two roots are consumed only by the offline cache builder.
...
# Hard isolation: training sees only target_offline_68 plus the inherited
# global binary-EMA-Teacher schedule.
DABE_BC_LAMBDA = 0.0
