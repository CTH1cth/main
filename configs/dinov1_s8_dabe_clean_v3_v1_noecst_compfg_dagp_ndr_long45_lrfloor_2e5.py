"""V1: consolidate complementary foreground evidence before Clean-DP."""
...
EXP_NAME = "dinov1_s8_dabe_clean_v3_v1_noecst_compfg_dagp_ndr_long45_lrfloor_2e5"
DABE_CLEAN_VERSION = "v3_offline_consolidation"
DABE_CLEAN_EXPECTED_PAYLOAD_VERSION = "dabe_clean_v3_offline_consolidation"
DABE_CLEAN_OFFLINE_MODE = "complementary_fg"
DABE_CLEAN_ROOT = (
    "../datasets/cache/dabe_clean_v3_v1_compfg_pseudo_cache/dinov1-s8"
)
